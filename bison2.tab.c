...
#line 1766 "bison2.tab.c"
  ...
  case 51:
#line 191 "bison2.y"
                                             { Asembler::dodajUListuArgumenata(new Argument(Operand::literal, "", (yyvsp[-2].reg)),0); Asembler::napraviInstrukciju(Token_Instrukcija::st, line_num); }
...
#line 193 "bison2.y"
                                 { 
      Asembler::napraviInstrukciju(Token_Instrukcija::csrrd, line_num, (yyvsp[0].reg), -1,-1, (yyvsp[-2].reg));
      }
...
#line 197 "bison2.y"
                                 { 
      Asembler::napraviInstrukciju(Token_Instrukcija::csrwr, line_num, (yyvsp[-2].reg), -1, -1, (yyvsp[0].reg));
      }
#line 1788 "bison2.tab.c"
  ...
  case 54:
#line 203 "bison2.y"
                { Asembler::Asembler::postaviAdresiranje(Adresiranje::SKOK); Asembler::dodajUListuArgumenata(new Argument(Operand::literal, "", (yyvsp[0].literal)));}
#line 1794 "bison2.tab.c"
    break;

  case 55:
#line 204 "bison2.y"
                 { Asembler::Asembler::postaviAdresiranje(Adresiranje::SKOK); Asembler::dodajUListuArgumenata(new Argument(Operand::simbol, (yyvsp[0].symbol), 0));}
